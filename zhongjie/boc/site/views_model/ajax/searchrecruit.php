<?php
$CI->load->model('recruit_model','mhr');
$page = 1;
if(!empty($reg[0])){
	$page = $reg[0];
}
...
$count = $CI->mhr->get_count_all($where);
$pages = _pages(site_url($url_base),$limit,$count,3);
$datalist = $CI->mhr->get_list($limit,$limit*($page-1),$orders,$where);
// echo $this->db->last_query();exit;
?>
<?php include_once VIEWS.'inc/head.php'; ?>
<?php echo static_file ('web/css/news1.css'); ?>
<h1 align='center'>招聘</h2>
<div class="newswarp1">
	<ul>
