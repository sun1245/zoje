...
require(['jquery','js/webuploader/webuploader','style!js/webuploader/webuploader.css','style!css/bootstrap.css'],function($,WebUploader){
      ...
      uploader = WebUploader.create({
          ...
          // swf文件路径
          swf: STATIC_URL + '/webuploader/js/Uploader.swf',

          disableGlobalDnd: true,

          chunked: true,
          // server: 'http://webuploader.duapp.com/server/fileupload.php',
          server: SITE_URL + 'uploader',
          fileNumLimit: 300,
