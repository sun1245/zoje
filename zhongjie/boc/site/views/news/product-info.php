...
<body>
    ...
    <div class="pd-wrap swiper-container">
        <div >
            ...
            <div class="part part2 swiper-slide">
                <div class="main">
                    <div class="con">
                        <ul class="f-cb">
                            <li class="l1">
            ...
            <div class="part part3 swiper-slide">
                <div class="font">
            ...
            <div class="part part6 swiper-slide">
                <div class="font">
            ...
            <div class="part part7 swiper-slide">
                <div class="left">
            ...
            <div class="part part8 swiper-slide">
                <div class="bg"></div>
                <div class="font">
            ...
            <div class="part part9 swiper-slide">
                <div class="font">
            ...
            <div class="part part10 swiper-slide">
                <div class="font">
            ...
            <div class="part part11 swiper-slide">
                <div class="line"></div>
                <div class="font">
                    <p class="t1">智能找模板<span>原点</span></p>
                    <p class="c1">实现快速定位，避免操作工在使用中因模板未放到未导致机针扎模板及浪费缝料等问题。</p>
            ...
            <div class="part part12 swiper-slide">
                <div class="video">
            ...
            <div class="part part13 swiper-slide">
                <div class="font">
...
$(function(){
    ...
    $(".sidemenu span").click(function(){
        var Page = $(this).index();
        // $(".sidemenu span").eq(Page).addClass('cur').siblings().removeClass('cur')
        $('.pd-wrap').animate({marginTop:-Page*height},250,function(){
                Mouse = false;
            });
    });
    ...
    $('body').on('mousewheel', function(event) {
        ...
        if(event.deltaY > 0){
            ...
            if( Page == 16 ){
                Page --
                $('.pd-wrap').animate({top:- 15*height},250,function(){
                    Mouse = true;
                });                
            }else{
                if( Page > 0 ){
                    Page --
                    $('.pd-wrap').animate({top:-Page*height},250,function(){
                        Mouse = true;
                    });   
                    $(".part").eq(Page - 1).addClass('list').removeClass('list')             
                }
                // 第一屏效果
                if( Page == 1 ){
                    $('.part1 .opc').each(function(){
            ...
            // 底部
            if( Page == 16 ){
                $('.pd-wrap').animate({top:- 15*height - footerHeight },250,function(){
                    Mouse = true;
                });                
            }else{
                $('.pd-wrap').animate({top:-Page*height},100,function(){
                    Mouse = true;
                    $('.part').eq(Page).addClass('list').siblings().removeClass('list')
                });
                ...
                if( Page == 1 ){
                    $('.part1 .opc').each(function(){
                        ...
                        // Enter($(".part1 .right .name").eq(0), 'left', 0, 4, 1000, 400);
                        // Enter($(".part1 .right .peo").eq(0), 'left', 0, 4, 2000, 400);
                        // Enter($(".part1 .right .peo").eq(0), 'left', 0, 4, 1000, 400);
                        setTimeout(function(){$('.part1 .right .name').addClass('show')},500);
                        setTimeout(function(){$('.part1 .right .peo').addClass('show')},1000);
                        setTimeout(function(){$('.part1 .right .peo').addClass('show')},1500);
                    });
                }else if(Page == 2){
                    $('.opc').removeClass("show")
                }
                // 第二屏效果
                if( Page == 1 ){
                    $(".part2 li").each(function(){
                        ...
                        if(index < 4){
                            setTimeout(function(){
                                $('.part2 li').eq(index+4).stop().addClass('show')
                                $('.part2 li').eq(index).stop().addClass('show')
                            },200*index);
                        }
                    });
                }else if(Page == 2){
                ...
                if( Page == 4 ){
                    // $('.part5 .img').addClass('show')
                    setTimeout(function(){$('.part5 .img').addClass('show')},1500);
                }else if(Page == 5){
                    $('.part5 .img').removeClass("show")
                }     
                ...
                // if( Page == 9 ){
                //     // $('.part5 .img').addClass('show')
                //     setTimeout(function(){$('.part10 .img').addClass('show')},1500);
                // }else if(Page == 10){
                //     $('.part5 .img').removeClass("show")
                // }             
    ...
    touch.on('body','swipeup',function(){
        ...
        if( p == 16 ){
            ...
            $('.pd-wrap').animate({marginTop:- 15*height - footerHeight },250);                
        }else{
            // 第一屏效果
            if( p == 1 ){
                $('.part1 .opc').each(function(){
            ...
            $('.pd-wrap').animate({marginTop:-p*height},250,function(){
                $('.part').eq(p).addClass('list').siblings().removeClass('list')
            }); 
            // 第11屏
            if( p == 10 ){
                $('.part11 .line').addClass('show')
    ...
    touch.on('body','swipedown',function(){
        if( p == 16 ){
            p --
            $('.pd-wrap').animate({marginTop:- 15*height},250);                
        }else{
            if( p > 0 ){
                p --
                $('.pd-wrap').animate({marginTop:-p*height},250);   
                $(".part").eq(p - 1).addClass('list').removeClass('list')             
            }
            // 第一屏效果
            if( p == 1 ){
                $('.part1 .opc').each(function(){
    ...
    $(".backtop").click(function(){
        ...
        // Page  = 0
        $('.pd-wrap').animate({top:0},100,function(){
            Mouse = true;
            $('.part').eq(0).addClass('list').siblings().removeClass('list')
        });
        Page = 0;
        p=0;
    })
