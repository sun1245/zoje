...
<head>
	...
	<?php
		echo static_file('web/css/style_ymq.css');
		echo static_file('web/css/jquery.fullPage.css');
		echo static_file('web/js/jquery.fullpage.js');
		echo static_file('web/js/base.js');
		echo static_file('web/js/countup.js');
	?>
</head>
<body>
			...
			<div id="fullpage">
			    ...
			    <div class="section page4">
			    	<div class="home_content">
			    		<div class="bg"></div>
			    		<div class="video">
			    			<video autoplay="autoplay" loop="loop" id="video" src="<?php echo static_file('web/video/part11.mp4')?>"></video>
			    		</div>
			    		<div class="con">
