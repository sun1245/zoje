    ...
    <div class="pd-wrap swiper-container">
        <div id="fullpage">
            ...
            <div class="part part11 swiper-slide section">
                <div class="line"></div>
                <div class="font">
                    <p class="t1"><span>压框导轨</span>互换技术</p>
                    <p class="c1">受力均匀，有效消除高速运转下而产生间隙，线迹稳定美观，缝制范围大，更快捷，模板使用成本更低。</p>
                </div>
            </div>
            <div class="part part12 swiper-slide section">
                <div class="video">
                    <video id="video" autoplay="autoplay" loop="loop" src="<?php echo static_file('web/video/part10.mp4')?>"></video>
                </div>
                <div class="bg"></div>
                <div class="font">
            ...
            <div class="part part16 swiper-slide section">
                <h2>主要参数</h2>
                <div class="list">
                    <ul class="f-cb">
                        <li>
            ...
            <div class="section page13 height-auto section">
