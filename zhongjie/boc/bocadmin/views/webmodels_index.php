<div class="btn-group">
	<a href="<?php echo site_url('adminmodels/create?mid='.$mid)?>" class='btn btn-primary' >  <i class="fa fa-plus"></i> 新闻模块  </a>
</div>
...
<div class="boxed">
	<div class="boxed-inner seamless">
		<?php echo form_open(site_url('webmodels/post_data'), array('class' => 'form-horizontal', 'id' => 'frm-edit')); ?>
