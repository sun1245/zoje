...
<div class="boxed">
	...
	<div class="boxed-inner seamless">
		...
		<div class="control-group">
			<label class="control-label" for="title"> 一句话简介 </label>
			<div class="controls">
				<input type="text" class='span7' id="title" name="title1" value="<?php echo set_value("title1") ?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="title"> 功能特色 </label>
			<div class="controls">
				<input type="text" class='span9' id="title" name="title2" value="<?php echo set_value("title2") ?>">
				<span class="help-inline">以 | 分隔</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="title"> 所属类别 </label>
			<div class="controls">
				<input type="text" class='span3' id="title" name="title3" value="<?php echo set_value("title3") ?>">
			</div>
		</div>
		<div class="control-group">
		...
		<!-- 图片上传 -->
		<div class="control-group">
			<label for="img" class="control-label">PC - 大图：</label>
			<div class="controls">
				<div class="btn-group">
		...
		<!-- 图片上传 -->
		<div class="control-group">
			<label for="img" class="control-label">PC - 1440：</label>
			<div class="controls">
				<div class="btn-group">
					<span class="btn btn-success">
						<i class="fa fa-upload"></i>
					...
					<input type="hidden" name="photo1" class="form-upload" data-more="0" value="<?php echo set_value("photo") ?>">
				</div>
			</div>
		</div>
		...
		<!-- 图片上传 -->
		<div class="control-group">
			<label for="img" class="control-label">手机图：</label>
			<div class="controls">
				<div class="btn-group">
					<span class="btn btn-success">
						<i class="fa fa-upload"></i>
					...
					<input type="hidden" name="photo2" class="form-upload" data-more="0" value="<?php echo set_value("photo") ?>">
				</div>
			</div>
		</div>
		<div id="js-photo2-show" class="js-img-list-f">
		</div>
		<div class="clear"></div>
		<!-- 图片上传 -->
...
<script type="text/javascript">
	...
	var banners_photos1 = <?php echo json_encode(one_upload(set_value("photo1"))) ?>;
	var banners_photos2 = <?php echo json_encode(one_upload(set_value("photo2"))) ?>;
	media.show(banners_photos,"photo");
	media.show(banners_photos1,"photo1");
	media.show(banners_photos2,"photo2");
});
