...
<body>
    ...
    <div class="page4 a0 main news-main">
    ...
    (screen,document,encodeURIComponent));"><img src="<?php echo static_file('web/img/news/icon7_03.png');?>"></a>
    			...
    			<div class="bot f-cb">
    				<div class="left">
                        ...
                        <a href="<?php echo site_url('culture/info/'.$rs['prev_id']); ?>">上一篇：<?php echo $rs['prev_title']; ?></a>
                        <?php } ?>
                        <?php if(isset($rs['next_id'])){ ?>
                        <a href="<?php echo site_url('culture/info/'.$rs['next_id']); ?> ">下一篇：<?php echo $rs['next_title']; ?></a>
                        <?php } ?>
    				</div>
    				<div class="right">
    					<label class="label1">
