...
<body>
    ...
    <div class="page7 a0 contact-main main">
    	...
    	<div class="page-nav">
    		<div class="con-wrap">
    			<a href="<?php echo site_url('contact')?>" class="on" ><div class="label1"><div class="label2">Domestic marketing</div></div></a>
    	...
    	<div class="list1">
    		<div class="con-wrap">
    			<p class="tit" style="text-align:center;">Partners</p>
    			<div class="con f-cb">
    				<p class="p1">Expand the global marketing network</p>
                    <?php echo $content;?>
    	...
    	<div class="list3">
			<div class="con-wrap">
    			<div class="con f-cb">
    				<p class="p1">ZOJE establishs unified visual 4S store worldwide. </p>
