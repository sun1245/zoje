...
<body>
    ...
    <div class="page3 a0 main news-main main">
    	...
    	<div class="page-nav">
    		<div class="news-wrap">
    			<a href="javascript:void(0)" class="on" data="1" ><div class="label1"><div class="label2">Company News</div></div></a>
    			<a href="javascript:void(0)" data="2"><div class="label1"><div class="label2">Trade News</div></div></a>
    			<a href="javascript:void(0)" data="3"><div class="label1"><div class="label2">News Video</div></div></a>
    		</div>
    	</div>
    	<div class="list1" id="news1">
    		<div class="news-wrap">
    			<p class="tit">Company News</p>
    			<div class="news-con">
    				<div class="pc f-cb">
