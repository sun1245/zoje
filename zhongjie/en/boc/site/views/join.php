...
<body>
    ...
    <div class="page6 a0 main join-main main">
    	...
    	<div class="page-nav">
    		<div class="join-wrap">
    			<a href="<?php echo site_url('join')?>" class="on" ><div class="label1"><div class="label2">Employment Ideality</div></div></a>
    			<a href="<?php echo site_url('join/recruit_social')?>"><div class="label1"><div class="label2">Social Recruitment</div></div></a>
                <a href="<?php echo site_url('join/recruit_campus')?>"><div class="label1"><div class="label2">Campus Recruitment</div></div></a>
    		</div>
    	</div>
        <div class="list1">
            <div class="join-wrap">
                <p class="tit">Employment Ideality</p>
                <div class="con">
                <?php echo $content;?>
