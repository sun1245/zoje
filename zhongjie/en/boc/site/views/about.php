	    			...
	    			<div class="vision-main">
	    				<ul class="f-cb">
	    					<li class="l1">
	    						...
	    						<p class="p1">ZOJE philosophy</p>
	    						<p class="p2">quality accomplishing outstanding ZOJE</p>
	    					</li>
	    					<li class="l2">
	    						<div><img src="<?php echo static_file('web/img/about/icon6_06.png')?>"></div>
	    						<p class="p1">OJE values</p>
	    						<p class="p2">our ZOJE our undertaking</p>
	    					</li>
	    					<li class="l3">
	    						<div><img src="<?php echo static_file('web/img/about/icon4_03.png')?>"></div>
	    						<p class="p1">ZOJE Vision</p>
	    						<p class="p2">Try to fight for being the operator of gobal apparel industrial electromagnet intergration equipment solutions and enhancing the garment culture of human being</p>
	    					</li>
	    				</ul>
	    			</div>
	    		</div>
