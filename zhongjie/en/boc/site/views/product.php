					...
					<ul class="f-cb">
		    			<li class="d1 f-cb">
		    				...
		    				<div class="right">
		    					...
		    					<a href="<?php echo $nlist[0]['link']?>">Learn More</a>
		    				</div>
		    			</li>
		    			<li class="d2 f-cb">
		    				<div class="right">
		    					...
		    					<a href="<?php echo $nlist[1]['link']?>">Learn More</a>
		    				</div>
		    			...
		    			<li class="d3 f-cb">
		    				<div class="right">
		    					...
		    					<a href="<?php echo $nlist[2]['link']?>">Learn More</a>
		    				</div>
    	...
    	<div class="pro-list2">
    		<div class="pro-wrap">
    			...
    			<div class="page-nav">
    				<div class="label1">
    					<div class="label2">
    						<p <?php if($ctype == 0){echo 'class="on"';} ?>>All</p>
