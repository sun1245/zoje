...
<body>
    ...
    <div class="page6 a0 main join-main main main">
    	<div class="banner">
    	...
    	<div class="page-nav">
    		<div class="join-wrap">
    			<a href="<?php echo site_url('join')?>"><div class="label1"><div class="label2">Employment Ideality</div></div></a>
    			<a href="<?php echo site_url('join/recruit_social')?>" class="on" ><div class="label1"><div class="label2">Social Recruitment</div></div></a>
    			<a href="<?php echo site_url('join/recruit_campus')?>"><div class="label1"><div class="label2">Campus Recruitment</div></div></a>
    		</div>
    	</div>
    	<div class="list3">
    		<div class="join-wrap">
    			<p class="tit">Campus Recruitment</p>
    			<div class="top f-cb">
    				<form action="<?php echo site_url('join/recruit_social')?>" method="get">
