...
<div class="btn-group"><a href="<?php echo site_url('users/index');?>" class="btn"> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?> </a></div>
...
<div class="boxed">
	...
	<div class="boxed-inner seamless">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class='span7' name="email" id="email" value="<?php echo set_value('email',$it['email']); ?>">				<span class="help-inline"></span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="password" class='span7' id="password" name="password" value="">
			</div>
		</div>
