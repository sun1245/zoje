...
<div class="btn-group">
	<a href="<?php echo site_url('onlineservice/index')?>" class='btn'> <i class="fa fa-arrow-left"></i> 返回列表</a>
</div>
...
<div class="boxed">
	...
	<div class="boxed-inner seamless">
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea name="link" rows="8"  class="input-xxlarge"><?php echo set_value('link') ?></textarea>
			</div>
		</div>
