...
<div class="boxed">
	...
	<div class="boxed-inner seamless">
		...
		<div class="control-group">
			<label for="title" class="control-label">一句话简介</label>
			<div class="controls">
			<input type="text" class='span7' name="title1" id="title" value="<?php echo set_value('title',$it['title1']); ?>">
				<span class="help-inline"></span>
			</div>
		</div>

		<div class="control-group">
			<label for="title" class="control-label">功能特色</label>
			<div class="controls">
			<input type="text" class='span7' name="title2" id="title" value="<?php echo set_value('title',$it['title2']); ?>">
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type="text" class='span7' name="title3" id="title" value="<?php echo set_value('title',$it['title3']); ?>">
				<span class="help-inline"></span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="btn-group">
					...
					<input type="hidden" name="photo1" class="form-upload" data-more="0" value="<?php echo set_value('photo',$it['photo1']) ?>">
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="btn-group">
					...
					<input type="hidden" name="photo2" class="form-upload" data-more="0" value="<?php echo set_value('photo',$it['photo2']) ?>">
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
		...
		var banners_photos1 = <?php echo json_encode(one_upload($it['photo1'])) ?>;
		var banners_photos2 = <?php echo json_encode(one_upload($it['photo2'])) ?>;
		media.init();
