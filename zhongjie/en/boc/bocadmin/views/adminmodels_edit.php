...
<div class="btn-group">
	<a href="javascript:history.go(-1)" class='btn'> <i class="icon-arrow-left"></i> 返回列表</a>
</div>
...
<div class="boxed">
	...
	<div class="boxed-inner seamless">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="type_id" value="<?php echo set_value('type_id',$it['type_id']) ?>" id="type_id">
			</div>
		</div>
	...
	<div class="boxed-footer">
		<input type="hidden" value="<?php echo $it['mid'] ?>" name="mid">
