...
<div class="btn-group">
	<a href="<?php echo site_url('users/index')?>" class='btn'> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?></a>
</div>
...
<div class="boxed">
	...
	<div class="boxed-inner seamless">
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class='span4' id="username" name="username" value="<?php echo set_value("username") ?>">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class='span4' id="email" name="email" value="<?php echo set_value("email") ?>">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="password" class='span4' id="password" name="password" value="<?php echo set_value("password") ?>">
			</div>
		</div>
