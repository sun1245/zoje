	...
	$sk.fn.extend({
		...
		animationGlassBlock: function(options)
		{
			...
			for (i = 0; i < total; i++) {
				...
				if($(window).width() > 1920){
                    var _fleft = (width_box * col) + (this.settings.width_skitter - this.box_skitter.find('.image_main').width() ) / 2;
                }else{
                    var _fleft = (width_box * (i));
                }
				...
				// var _bleft = -(width_box * (i));
				if($(window).width() > 1920){
                    var _bleft = -(width_box * (i)) + (this.settings.width_skitter - this.box_skitter.find('.image_main').width() ) / 2;
                }else{
                    var _bleft = -(width_box * (i));
                }
				var _btop = 0;
